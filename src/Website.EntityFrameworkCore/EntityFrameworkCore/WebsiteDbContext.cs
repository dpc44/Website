    ...
    ITenantManagementDbContext
{
    ...
    public DbSet<Category> CategoriesWebsite { get; set; }
    public DbSet<User> UsersWebiste { get; set; }
    ...
    protected override void OnModelCreating(ModelBuilder builder)
    {
        ...
        //{
        //    b.ToTable(WebsiteConsts.DbTablePrefix + "YourEntities", WebsiteConsts.DbSchema);
