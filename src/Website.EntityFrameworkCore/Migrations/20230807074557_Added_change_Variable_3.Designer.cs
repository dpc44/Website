...
namespace Website.Migrations
{
    ...
    [Migration("20230807074557_Added_change_Variable_3")]
    partial class AddedchangeVariable3
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Website.Articles.Article", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<DateTime>("DatePublishment")
                        .HasColumnType("datetime2");
                    ...
                    b.ToTable("ArticlesWebsite");
                });

            modelBuilder.Entity("Website.Categories.Category", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("CategoriesWebsite");
                });

            modelBuilder.Entity("Website.Files.CSV", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("CSVWebsite");
                });

            modelBuilder.Entity("Website.Files.TableList", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<string>("BreakdownCategory")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.Property<string>("RdValue")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("RelativeSamplingError")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("Website.Users.User", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Website.Articles.Article", b =>
                {
                    b.HasOne("Website.Categories.Category", "Category")
                        .WithMany()
